...
***\* Dodatna pojasnila:***
- Nastavitev št. **18** je namenjena intenzivnejšemu varčevanju z delovnim pomnilnikom (RAM), vendar pa bo brskalnik v primeru spremembe privzete vrednosti (iz 8 na 4) morda postal nekoliko manj odziven v scenariju z večjim številom odprtih zavihkov. Spreminjanje te vrednosti je zato koristno samo pri tistih računalnikih, ki uporabljajo manj kot 3 GB RAM-a.
...
- [StartPage](https://www.startpage.com/): bazira na iskalniku Google, pri čemer naj bi se iskalne poizvedbe anonimizirale

<h4>5.b) ZA IZOGIB GEOGRAFSKIM OMEJITVAM IN DIGITALNIM PREPREKAM</h4>

Za bolj intenzivno prikrivanje svoje lokacije in (pogojno) identitete se lahko precej učinkovito uporabi kakovostno omrežje VPN. VPN lahko usposobimo z namestitvijo programa (ki deluje na ravni celotnega sistema) ali z namestitvijo dodatka v brskalnik (ki deluje samo znotraj brskalnika z vklopljenim VPN dodatkom). Eden od seznamov z uveljavljenimi VPN ponudniki se nahaja recimo [na tej strani](https://www.techradar.com/vpn/best-vpn).
...
**OPOMBA:** kljub uporabi vseh dodatkov, datoteke hosts, anonimnih spletnih iskalnikov, VPN omrežij in ostalih zaščitnih mehanizmov je potrebno poudariti, da **popolne anonimnosti na spletu žal ni**. Še vedno namreč komunikacija neizogibno poteka preko telekomunikacijskih ponudnikov, različnih posredniških strežnikov in naprav. Poleg tega uporabniki navadno uporabljamo različne spletne storitve: e-pošta (v obliki klienta ali spletne storitve), socialna omrežja, forumi in drugi portali... V primeru uporabe teh storitev nas vsi omenjeni ukrepi ščitijo v omejenem obsegu. Vsekakor nam sicer občutno olajšajo hitrost, preglednost in varnost spletnega brskanja, ne zagotavljajo pa popolne anonimnosti – vsaj ne vedno in v vsakem scenariju.
